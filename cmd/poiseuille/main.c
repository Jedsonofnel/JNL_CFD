 ...
 * BCs:
 *   west:        Ux = U_IN, Uy = 0
 *   east:        zero-gradient U, p = 0
 *   north/south: no-slip U, zero-gradient p
 *
 * Expected:
 *   Ux = 6*U_IN*y*(H-y)/H^2
 *   Uy = 0
...
int main(void)
{
	...
	printf("Poiseuille: %d real cells, %d total cells, %d faces\n", n_real,
	       n_cells, n_faces);
	...
	//
	// Analytical check on real cells only.
	//
