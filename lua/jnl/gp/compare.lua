...
M._doc = "Comparison plotting helpers for numerical, analytical, and reference profiles"

M._doc_subsection =
	"Use jnl.gp.compare for validation plots such as numerical versus analytical " ..
...
local function assert_profile(name, p)
	...
	assert(#p.coord == #p.value, name .. ".coord and .value must have same length")
end
