...
h.describe("pen tagging", function()
    ...
    h.it(":tag() with no segments errors", function()
        h.expect(function()
            pen.new():at(0, 0):tag("x")
        end).throws()
    end)

    h.it(":get() unknown name errors", function()
        h.expect(function()
            pen.new():at(0, 0):east(1):get("nope")
        end).throws()
    end)
...
h.describe("pen build", function()
    ...
    h.it("multiple segments produce a chain", function()
        h.expect(pen.new():at(0, 0):east(1):north(1):build():kind())
            .equals("chain")
    end)
...
h.describe("pen arc movement", function()
    h.it(":arc_turn() moves the position", function()
        ...
        local x, y = p:pos()
        h.expect(math.sqrt(x * x + y * y) > 0.1)
            .is_truthy("position should have moved")
    end)

    h.it(":arc_turn() zero radius errors", function()
        h.expect(function()
            pen.new():at(0, 0):arc_turn(90, 0)
        end).throws()
    end)

    h.it(":arc_turn() zero delta errors", function()
        h.expect(function()
            pen.new():at(0, 0):arc_turn(0, 1)
        end).throws()
    end)

    h.it(":arc_to() degenerate target errors", function()
        h.expect(function()
            pen.new():at(1, 1):arc_to(1, 1, 1)
        end).throws()
    end)

    h.it(":arc_to() radius too small errors", function()
        h.expect(function()
            pen.new():at(0, 0):arc_to(10, 0, 0.1)
        end).throws()
    end)
