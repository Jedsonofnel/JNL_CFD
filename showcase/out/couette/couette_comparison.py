#!/usr/bin/env python3
"""
Couette flow validation — analytical vs numerical velocity profile.

Reads:
  couette_comparison.csv

Expected columns:
  x_Numerical,y_Numerical,x_Analytical,y_Analytical

Writes:
  couette_comparison.pdf
  couette_comparison.png
"""
...
def plot_comparison(path="couette_comparison.csv"):
    ...
    ax.set_xlabel(r"$u \,/\, U_\mathrm{wall}$")
    ax.set_ylabel(r"$y \,/\, H$")
    ax.set_title(r"$\bf{Couette\ Flow\ Validation}$")
