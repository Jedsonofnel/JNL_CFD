                           ...
                           i32 n_real_cell_scratch, i32 n_face_scratch)
{
	...
	return ARENA_SIZE(struct jnl_fvm_ctx, 1) +
	       ...
	       jnl_scratch_pool_arena_size(n_real_cells, n_real_cell_scratch) +
	       ...
	       jnl_fvsys_arena_size(mesh) * (u64)n_systems;
}
                                    ...
                                    i32 n_face_scratch)
{
	...
	u64 arena_sz = jnl_fvm_ctx_arena_size(mesh, n_fields, n_face_fields,
	                                      n_systems, n_cell_scratch,
	                                      n_real_cell_scratch, n_face_scratch);
