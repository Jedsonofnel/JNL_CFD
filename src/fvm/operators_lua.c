...
static int l_ddt_k(lua_State *L)
{
	...
	jnl_ddt_k(s, m, rho, dt, phi_old->data);
	return 0;
}
...
static int l_ddt_f(lua_State *L)
{
	...
	jnl_ddt_f(s, m, rho->data, dt, phi_old->data);
	return 0;
}
...
static int l_laplacian_f(lua_State *L)
{
	...
	jnl_laplacian_f(s, m, gamma->data);
	return 0;
}
...
static int l_laplacian_nonorth_k(lua_State *L)
{
	...
	jnl_laplacian_nonorth_k(s, m, gamma, gx->data, gy->data);
	return 0;
}
...
static int l_laplacian_nonorth_f(lua_State *L)
{
	...
	jnl_laplacian_nonorth_f(s, m, gamma->data, gx->data, gy->data);
	return 0;
}
...
static int l_div_cds_f(lua_State *L)
{
	...
	jnl_div_cds_f(s, m, rho->data, un->data);
	return 0;
}
...
static int l_div_uds_f(lua_State *L)
{
	...
	jnl_div_uds_f(s, m, rho->data, un->data);
	return 0;
}
...
static int l_div_tvd_minmod(lua_State *L)
{
	...
	jnl_div_tvd_correction_minmod(s, m, phi->data, gx->data, gy->data,
	                              un->data);
	return 0;
}
...
static int l_div_tvd_van_leer(lua_State *L)
{
	...
	jnl_div_tvd_correction_van_leer(s, m, phi->data, gx->data, gy->data,
	                                un->data);
	return 0;
}
...
static int l_div_tvd_superbee(lua_State *L)
{
	...
	jnl_div_tvd_correction_superbee(s, m, phi->data, gx->data, gy->data,
	                                un->data);
	return 0;
}
...
{
	jnl_su_v_k(check_fvsys(L, 1), check_pmsh2d(L, 2), luaL_checknumber(L, 3));
	return 0;
}

static int l_su_v_f(lua_State *L)
{
	jnl_su_v_f(check_fvsys(L, 1), check_pmsh2d(L, 2), check_vec(L, 3)->data);
	return 0;
}
...
static int l_su_v_fs(lua_State *L)
{
	...
	jnl_su_v_fs(check_fvsys(L, 1), check_pmsh2d(L, 2), scale,
	            check_vec(L, 4)->data);
	return 0;
}
...
{
	jnl_su_i_k(check_fvsys(L, 1), check_pmsh2d(L, 2), luaL_checknumber(L, 3));
	return 0;
}

static int l_su_i_f(lua_State *L)
{
	jnl_su_i_f(check_fvsys(L, 1), check_pmsh2d(L, 2), check_vec(L, 3)->data);
	return 0;
}
...
{
	f64 scale = luaL_checknumber(L, 3);
	jnl_su_i_fs(check_fvsys(L, 1), check_pmsh2d(L, 2), scale,
	            check_vec(L, 4)->data);
	return 0;
}
...
{
	jnl_sp_v_k(check_fvsys(L, 1), check_pmsh2d(L, 2), luaL_checknumber(L, 3));
	return 0;
}

static int l_sp_v_f(lua_State *L)
{
	jnl_sp_v_f(check_fvsys(L, 1), check_pmsh2d(L, 2), check_vec(L, 3)->data);
	return 0;
}
...
{
	f64 scale = luaL_checknumber(L, 3);
	jnl_sp_v_fs(check_fvsys(L, 1), check_pmsh2d(L, 2), scale,
	            check_vec(L, 4)->data);
	return 0;
}
...
{
	jnl_sp_i_k(check_fvsys(L, 1), check_pmsh2d(L, 2), luaL_checknumber(L, 3));
	return 0;
}

static int l_sp_i_f(lua_State *L)
{
	jnl_sp_i_f(check_fvsys(L, 1), check_pmsh2d(L, 2), check_vec(L, 3)->data);
	return 0;
}
...
{
	f64 scale = luaL_checknumber(L, 3);
	jnl_sp_i_fs(check_fvsys(L, 1), check_pmsh2d(L, 2), scale,
	            check_vec(L, 4)->data);
	return 0;
}
